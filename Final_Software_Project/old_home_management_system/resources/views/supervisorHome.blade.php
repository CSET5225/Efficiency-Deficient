...
<body>
  ...
  <div class="div1">
    ...
    <button>
            <a href="patientAddInfo" class="a">Addtional Patient Info </a>
        </button>
        <br>
        <button>
        ...
        <div class="div2">
        <button>
            <a href="" class="a">Employee Database</a>
        </button>
        <br>
        <button>
       ...
       <div class="div3">
       <button>
            <a href="registrationApproval" class="a">Registration Approval</a>
        </button>
        <br>
        <button>
            <a href="rosterView" class="a">Roster</a>
        </button>
        <br>
       </div>
